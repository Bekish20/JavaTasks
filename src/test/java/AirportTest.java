...
public class AirportTest {
    ...
    public void testGetTransportMilitaryPlanes() {
        ...
        Assert.assertEquals(MilitaryType.TRANSPORT, militaryPlane.getType());
    }
    ...
    public void testSortedByMaxLoadCapacity() {
        ...
        int i = planesSortedByMaxLoadCapacity.size();
        Plane currentPlane = planesSortedByMaxLoadCapacity.get(i-2);
    ...
    public void testHasAtLeastOneBomberInMilitaryPlanes() {
        ...
        MilitaryPlane militaryPlane = bomberMilitaryPlanes.get(0);
        Assert.assertEquals( MilitaryType.BOMBER , militaryPlane.getType());
    }
    ...
    public void testExperimentalPlanesHasClassificationLevelHigherThanUnclassified(){
        ...
        ExperimentalPlane experimentalPlane = experimentalPlanes.get(0);
