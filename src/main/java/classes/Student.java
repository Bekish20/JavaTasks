...
public class Student {
    ...
    public static void main(String[] args) {
        ...
        stu[0] = new Student(1,"Volk1","Andrei","Volkov1",new Date (1990,9,8),
                "gai 17a", 666312,"FSK",5,402);
        stu[1] = new Student(2,"Volk2","Andrei","Volkov2",new Date (1989,1,9),
                "gai 20", 666313,"FSK",5,403);
        stu[2] = new Student(3,"Volk3","Andrei","Volkov3",new Date (1991,9,12),
                "gai 21", 666314,"FSK",4,400);
        stu[3] = new Student(4,"Volk4","Andrei","Volkov4",new Date (1993,8,8),
                "gai 22", 666315,"ISF",4,401);
        stu[4] = new Student(5,"Volk5","Andrei","Volkov5",new Date (1988,7,3),
                "gai 23", 666316,"FFF",3,400);
        stu[5] = new Student(6,"Volk6","Andrei","Volkov6",new Date (1993,8,25),
                "gai 24", 666317,"ISF",5,402);
        stu[6] = new Student(7,"Volk7","Andrei","Volkov7",new Date (1994,3,24),
                "gai 25", 666318,"FFF",5,403);
        stu[7] = new Student(8,"Volk8","Andrei","Volkov8",new Date (1990,4,18),
                "gai 25", 666319,"ISF",5,406);
        stu[8] = new Student(9,"Volk9","Andrei","Volkov9",new Date (1991,4,16),
                "gai 26", 666320,"FFF",1,407);
        stu[9] = new Student(10,"Volk10","Andrei","Volkov10",new Date (1992,2,15),
                "gai 27", 666321,"FFF",5,401);
        ...
        return "Id:"+id+" Syrname:"+surname+" Name:"+name+" Middlename:"+middlename+" Date of birth:"+dateofBirth.getDate()+"."
         ...
         public void showFac(String x) {
           ...
           public void showFacCours(String y,int z) {
            ...
            System.out.println(getId() + ":" + getSurname() + " " + getName() + " " + getMiddlename()+" Course "+getCourse());
              }
             }
